...
class ModbusRTUDevice(Document):
    def before_save(self):
        ...
        try:
            ...
            msg += f"No of Retrieve: {getattr(self, 'no_of_retrieve', 'N/A')}\n"
        ...
        device_info = {
            ...
            "No of Retrieve": getattr(self, 'no_of_retrieve', 'N/A'),
    ...
    def onload(self):
        ...
        if not getattr(self, 'json_data', None):
            ...
            url = "https://www.jsonkeeper.com/b/F9HA"  # Replace with your desired URL
            ...
            try:
                ...
                setattr(self, 'no_of_retrieve', device_info.get("No of Retrieve", ''))
